...
class Agent():
    def __init__(self, n_actions, input_dims, lr, log):
        ...
        self.n_actions = n_actions
        self.input_dims = input_dims
        self.Q_eval = DQN(self.lr, n_actions=self.n_actions, input_dims=self.input_dims, fc1_dims=128, fc2_dims=64, fc3_dims=32)
        self.Q_eval_target = DQN(self.lr, n_actions=self.n_actions, input_dims=self.input_dims, fc1_dims=128, fc2_dims=64, fc3_dims=32)
    ...
    def choose_train_action(self, features):
        if np.random.random() > self.epsilon:            
            ...
            state = T.tensor(features).to(self.Q_eval.device)
