...
class Agent():
    def __init__(self, n_actions, input_dims, lr, log):
        ...
        self.Q_eval = DQN(self.lr, n_actions=self.n_actions, input_dims=self.input_dims, fc1_dims=16, fc2_dims=12)
        self.Q_target = DQN(self.lr, n_actions=self.n_actions, input_dims=self.input_dims, fc1_dims=16, fc2_dims=12)
