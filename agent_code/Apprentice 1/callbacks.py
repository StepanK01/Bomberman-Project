...
def setup(self):
    ...
    self.agent = Agent(n_actions=3, input_dims=self.input_dim, lr=0.0001, log=self.logger.debug) 
...
def state_to_features(self, game_state: dict) -> np.array:
    ...
    *This is not a required function, but an idea to structure your code.*
    ...
    self.bomb_values.calc_value_field(agent_pos, crates_pos, other_agents_pos, walls_field, obstacle_field_reduced, danger_field, self.num_coins) 
