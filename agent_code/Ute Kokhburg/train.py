...
def game_events_occurred(self, old_game_state: dict, self_action: str, new_game_state: dict, events: List[str]):
    ...
    # The features of the game state where already calculated in the act function and stored to avoid running the gamestate_to_features twice
...
def end_of_round(self, last_game_state: dict, last_action: str, events: List[str]):
    ...
    reward = reward_from_events(self, events)
    self.score += reward
    # last_game_state two times, since it is arbitrary, since q_next is set to 0
